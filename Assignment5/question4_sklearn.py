...
from utils import data_split, evaluate_model
...
def MLPSearch(X_train, y_train, use_subset=False):
...
if __name__ == "__main__":
    ...
    # hidden_layer_sizes = MLPSearch(X_train, y_train, False) # Uncomment if you like to suffer for about 40ish minutes. 
    # Don't forget to uncomment next line!!!!
    hidden_layer_sizes = (72, 62, 62, 72, 23, 60, 36, 61, 54, 98, 41, 33, 62, 71, 53, 11) 
    model = train_final_model(X_train, y_train, hidden_layer_sizes=hidden_layer_sizes)
    evaluate_model(model, X_test, y_test, "MLP", "micro")