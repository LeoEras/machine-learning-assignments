...
# This has sense as K is large
print("\nUSING THE CROSS VALIDATION APPROACH, K = 5")
k_folds = KFold(n_splits = 5)
scores = cross_val_score(LinearRegression(), x_dataset, y_labels, cv = k_folds)
print("Cross Validation Scores: ", scores)
print("Average CV Score: ", scores.mean())
print("Number of CV Scores used in Average: ", len(scores))

# Using cross-validation (k = 10)
# This should perform worse as K is large (compared to k = 5)
print("\nUSING THE CROSS VALIDATION APPROACH, K = 10")
